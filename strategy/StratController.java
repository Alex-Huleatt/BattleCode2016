...
public class StratController {
    ...
    /**
     * TODO Current jobs should depend on current strats.
     */
    ...
    /**
     * Write the current jobs to the radio in terms of priority.
     */
    public void employ() {
        radC.resetQueue("jobs"); //clear the queue.
